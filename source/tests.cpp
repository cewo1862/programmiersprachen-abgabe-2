...
TEST_CASE("describeDefaultVecConstructor","[DefaultVecConstructor]"){		//Vektortests
	Vec2 v;
	REQUIRE(v.x == 0.0f);
	REQUIRE(v.y == 0.0f);
}
...
TEST_CASE("describeAddVecSelf","[AddVecSelf]"){
	...
	v3+=v1;
	REQUIRE(v3.x == Approx(1.7));
	REQUIRE(v3.y == Approx(6.0));
}
...
TEST_CASE("describeAddVecS","[AddVec]"){
	Vec2 v1{1.0,5.0};
	Vec2 v2{0.3,0.5};
	Vec2 v3{0.7,1.0};
	Vec2 r1=v1+v2;
...
TEST_CASE("describeDefaultMatConstructor","[DefaultMatConstructor]"){		//Matrixtests
	Mat2 m;
	REQUIRE(m.a11 == 1.0f);
	REQUIRE(m.a12 == 0.0f);
	REQUIRE(m.a21 == 0.0f);
...
TEST_CASE("describeMultMatSelf","[MultMatSelf]"){
	...
	m1*=m2;
	REQUIRE(m1.a11==Approx(7.0f));
	REQUIRE(m1.a12==Approx(14.0f));
	REQUIRE(m1.a21==Approx(42.0f));
	REQUIRE(m1.a22==Approx(70.0f));
	m2*=m3;
	REQUIRE(m2.a11==Approx(9.0f));
	REQUIRE(m2.a12==Approx(6.0f));
	REQUIRE(m2.a21==Approx(44.0f));
	REQUIRE(m2.a22==Approx(0.0));
	m3*=m1;
	REQUIRE(m3.a11==Approx(25.0f));
	REQUIRE(m3.a12==Approx(10.0f));
	REQUIRE(m3.a21==Approx(22.0f));
	REQUIRE(m3.a22==Approx(55.0f));
}
...
TEST_CASE("describeMultMat","[MultMat]"){
	...
	Mat2 m3{3.0,2.0,5.5,0.0};
	Mat2 r1=m1*m2;
	REQUIRE(r1.a11==Approx(7.0f));
	REQUIRE(r1.a12==Approx(14.0f));
	REQUIRE(r1.a21==Approx(42.0f));
	REQUIRE(r1.a22==Approx(70.0f));
	Mat2 r2=m2*m3;
	REQUIRE(r2.a11==Approx(9.0f));
	REQUIRE(r2.a12==Approx(6.0f));
	REQUIRE(r2.a21==Approx(44.0f));
	REQUIRE(r2.a22==Approx(0.0));
	Mat2 r3=m3*=m1;
	REQUIRE(r3.a11==Approx(25.0f));
	REQUIRE(r3.a12==Approx(10.0f));
	REQUIRE(r3.a21==Approx(22.0f));
	REQUIRE(r3.a22==Approx(55.0f));
}
...
EST_CASE("describeRotation","[Rotation]"){
	Mat2 m1{12.0,0.0,4.0,100.0};
...
TEST_CASE("describeCircDefault","[CircDefault]"){		//Kreistests
	Circle c;
...
//TEST_CASE("describeRectDefault","[RectDefault]"){		//Rechtecktests
//	Rectangle r;
...
//	Rectangle r1{v1,{}};
//	Rectangle r2{v2,{}};
//	REQUIRE(r1.getHeight()==5.0);
//	REQUIRE(r2.getHeight()==2.0);
//}
...
//	Vec2 v1{1.0,5.0}
//	Rectangle r2{v1,{0.3,1.0,0.0}};
//	REQUIRE(r2.getColor().r==Approx(0.3f));
//	REQUIRE(r2.getColor().g==Approx(1.0f));
//	REQUIRE(r2.getColor().b==Approx(0.0f));
//	Vec2 v2{0.2,2.0}
//	Rectangle r3{v2,{0.5,1.0,5.0}};
//	REQUIRE(r3.getColor().r==Approx(0.5f));
//	REQUIRE(r3.getColor().g==Approx(1.0f));
//	REQUIRE(r3.getColor().b==Approx(0.0f));
//}
